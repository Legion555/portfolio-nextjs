...
export default function Home() {
    return (
        ...
        <div className="w-full h-screen flex justify-center absolute top-0 left-0">
            <div className="mt-40">
                <h1 className="mb-4 md:mb-8 text-5xl md:text-6xl xl:text-8xl text-yellow-300">joshua_lausberg</h1>
                <p className="text-2xl md:text-4xl xl:text-6xl text-gray-200">front-end_developer</p>
                <div className="mt-16 flex justify-center">
                    <Link
                        className="px-8 py-4 text-xl md:text-2xl text-gray-200 hover:bg-yellow-400 hover:text-gray-800 cursor-pointer"
